...
export const home = {
  hero: {
    ...
    note: {"no":"ERP, CRM, Excel, Business Intelligence (BI), maskindata/OT og fagsystemer kan gjerne bli stående. Vi gjør informasjonen tilgjengelig på tvers og bruker den som et trygt grunnlag for AI.","en":"Your ERP, CRM, Excel, Business Intelligence (BI), machine data/OT and line-of-business systems can stay. We make the information available across them and use it as a safe foundation for AI."},
    stats: [
