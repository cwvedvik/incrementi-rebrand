...
export const home = {
  hero: {
    ...
    lead: {"no":"Vi samler data fra systemene dere allerede har, og bygger et fundament for innsikt og automatisering.","en":"We gather data from the systems you already have, and build a foundation for insight and automation."},
