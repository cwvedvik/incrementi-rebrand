...
export function IconDirection(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <path d="M12 12L16.2 7.8" className="icon-accent" stroke="var(--accent-strong)" />
...
export function IconPrototype(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <path d="M7 12.5h7" className="icon-accent" stroke="var(--accent-strong)" />
    </Svg>
  );
}
...
export function IconData(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <path d="M15 12h6" className="icon-accent" stroke="var(--accent-strong)" strokeWidth="1.6" />
      <path d="M19.5 10v4" className="icon-accent" stroke="var(--accent-strong)" />
    </Svg>
  );
}
...
export function IconOs(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <rect x="5.5" y="5.5" width="5" height="5" rx="0.3" className="icon-accent" fill="var(--accent)" fillOpacity="0.18" stroke="var(--accent-strong)" />
...
export function IconContext(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <path d="M18.5 7.5c2 2.2 2 7.2 0 9.5" className="icon-accent" stroke="var(--accent-strong)" />
    </Svg>
  );
}
...
export function IconAgents(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <circle cx="17.5" cy="8" r="2.4" className="icon-accent" stroke="var(--accent-strong)" />
      <path d="M17.5 10.4v6.2M16.2 14.2h2.6M16.2 16.2h2.2" className="icon-accent" stroke="var(--accent-strong)" />
    </Svg>
  );
}
...
export function IconMaritime(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <path d="M10 20c1 .9 2 1.4 2.5 1.4s1.5-.5 2.5-1.4" className="icon-accent" stroke="var(--accent-strong)" opacity="0.9" />
    </Svg>
  );
}
...
export function IconIndustrial(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <path d="M6 8h12.5" />
      <path d="M18.5 8v3" />
      <circle cx="18.5" cy="13.5" r="1.6" className="icon-accent" stroke="var(--accent-strong)" />
...
export function IconFinance(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <path d="M17 6.5h3.5v3.2c0 1.4-1.1 2.3-2.2 2.3h-1.3" className="icon-accent" stroke="var(--accent-strong)" />
      <rect x="18.2" y="8.2" width="1.4" height="1.6" rx="0.2" fill="var(--accent-strong)" stroke="none" />
    </Svg>
  );
}
...
export function IconOwnership(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <circle cx="17.5" cy="9" r="2.2" className="icon-accent" stroke="var(--accent-strong)" />
      <path d="M17.5 11.2v6.5M16.2 14.5h2.6M16.2 16.5h2" className="icon-accent" stroke="var(--accent-strong)" />
    </Svg>
  );
}
...
export function IconConsulting(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <circle cx="18" cy="12" r="1.4" className="icon-accent" stroke="var(--accent-strong)" />
    </Svg>
  );
}
  ...
  return (
    <Svg {...props}>
      ...
      <path
        ...
        strokeWidth="1.8"
      />
      <path d="M12 12L15.5 8.2" stroke="var(--accent-strong)" />
